...
winewhite$free.sulfur.dioxide[which(winewhite$residual.sugar %in% bx5$out)] = NA

bx6 <- boxplot(winewhite$total.sulfur.dioxide)  
winewhite$free.sulfur.dioxide[which(winewhite$residual.sugar %in% bx6$out)] = NA

bx7 <- boxplot(winewhite$density)  
winewhite$density[which(winewhite$residual.sugar %in% bx7$out)] = NA
