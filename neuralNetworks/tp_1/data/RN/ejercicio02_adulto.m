...
datos=csvread('G://RN/data/adult1_class_intercalate.csv');
...
train = datos(1:cant_rows_train, 1:3)';
X = train;
T = datos(1:cant_rows_train,4)';

%obteniendo testing

test = datos(cant_rows_train+1:cant_rows, 1:3)';
T_test = datos(cant_rows_train+1:cant_rows, 4)';
...
while (alfa < 0.6)
    ...
    while (Max_It < 4001)
         ...
         while (i < 10)
            ...
            titulo = strcat('RN_adult1_class_intercalate', num2str(alfa));
            ...
            csv(nrow,:) = [i, nrow, alfa, Max_It, b, W(1), W(2), W(3), Ite, Aciertos];
            nrow = nrow + 1;
